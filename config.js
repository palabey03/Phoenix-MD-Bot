...
//____________________________________________________________________________________________________________________________________________  
  //🤖 BOT CONFIGURATION
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~CobraVigilant',
  STICKER_DATA: process.env.STICKER_DATA || '🎯ᴘʜᴏᴇɴɪx-ᴍᴅ;PALA ꜱᴜʀᴇꜱʜ🍀',
  ...
  BOT_INFO: process.env.BOT_INFO || 'ᴘʜᴏᴇɴɪx-ᴍᴅ;ᴀʙʜɪꜱʜᴇᴋ ꜱᴜʀᴇꜱʜ;905075979782;https://i.ibb.co/tHWJrz3/IMG-20231128-WA0005.jpg', 
  ...
  SUDO: process.env.SUDO || '905075979782, 905075979782',
  ELEVENLABS_API_KEY: process.env.ELEVENLABS_API_KEY || '',
  TIMEZONE: process.env.TIMEZONE || "PALA/Kolkata",
